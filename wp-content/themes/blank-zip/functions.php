...
if ( ! function_exists( 'blank_zip_setup' ) ) :
	...
	function blank_zip_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'blank-zip' ),
		) );
...
function blank_zip_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'blank_zip_content_width', 640 );
}
...
function blank_zip_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'blank-zip' ),
		'id'            => 'sidebar-1',
...
function blank_zip_scripts() {
	...
	wp_enqueue_script( 'blank-zip-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'blank-zip-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
